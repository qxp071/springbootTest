...
import cn.example.mp.test.util.MD5Util;
...
public class RedisUtils {
    ...
    public static String KEY_PREFIX ="spring.redis.keyPrefix";
    public static Long expireTime= 1800L;
    public static Long expireTimeShiro= 1800L;
    ...
    public static String getTotalKey(String className,String keyId){
        if(className==null){className="";}
        if(keyId==null){keyId="";}
        return RedisUtils.KEY_PREFIX+className+RedisUtils.TOTAL_KEY+MD5Util.md5(keyId).substring(0,20);
    }

    public static String getFindListKey(String className,String keyId){
        if(className==null){className="";}
        if(keyId==null){keyId="";}
        return RedisUtils.KEY_PREFIX+className+RedisUtils.FIND_LIST_KEY+MD5Util.md5(keyId).substring(0,20);
    }

    public static String getFindListFirstKey(String className,String keyId){
        if(className==null){className="";}
        if(keyId==null){keyId="";}
        return RedisUtils.KEY_PREFIX+className+RedisUtils.FIND_LIST_FIRST_KEY+MD5Util.md5(keyId).substring(0,20);
    }

    public static String getFindPageKey(String className,String keyId){
        if(className==null){className="";}
        if(keyId==null){keyId="";}
        return  RedisUtils.KEY_PREFIX+className+RedisUtils.FIND_PAGE_KEY+ MD5Util.md5(keyId).substring(0,20);
    }
